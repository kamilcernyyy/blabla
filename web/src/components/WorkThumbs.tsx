...
export function WebThumb() {
  return (
    <svg viewBox="0 0 450 600" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
      ...
      {[0,1,2].map(i => (
        <g key={i}>
          <rect x={50 + i*115} y="276" width="96" height="54" rx="6" fill="rgba(255,255,255,0.05)" stroke="rgba(255,255,255,0.08)" strokeWidth="1" />
      ...
      {[0,1].map(i => (
        <g key={i}>
          <rect x={50 + i*168} y="360" width="152" height="96" rx="6" fill="rgba(255,255,255,0.05)" stroke="rgba(255,255,255,0.08)" strokeWidth="1" />
